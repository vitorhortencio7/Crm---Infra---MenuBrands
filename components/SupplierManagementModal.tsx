        ...
        <div className="flex-1 overflow-y-auto p-6 bg-white dark:bg-slate-800">
                            ...
                            <div key={sup.id} className="flex items-center justify-between p-4 bg-gray-50 dark:bg-slate-700/50 rounded-xl border border-gray-100 dark:border-slate-600 hover:shadow-md transition-all group">
                                <div>
                                    ...
                                    <div className="flex flex-wrap items-center gap-3 mt-1">
                                        ...
                                        {sup.contactName && <span className="text-xs text-indigo-500 dark:text-indigo-400 font-medium flex items-center gap-1"><UserIcon size={10} /> {sup.contactName}</span>}
                                        {sup.contact && <span className="text-xs text-slate-400 dark:text-slate-500 flex items-center gap-1"><Phone size={10} /> {sup.contact}</span>}
                                    </div>
                                </div>
                                <button 
            ...
            {view === 'form' && (
                <div className="space-y-4">
                    ...
                    <div>
                        <label className="block text-xs font-bold text-gray-500 dark:text-gray-400 uppercase mb-1.5 ml-1">Nome do Contato</label>
                        <div className="relative">
                    ...
                    <div>
                        <label className="block text-xs font-bold text-gray-500 dark:text-gray-400 uppercase mb-1.5 ml-1">Contato / Telefone</label>
                        <div className="relative">
